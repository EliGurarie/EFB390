...
- 9. [The Niche Concept](lectures/Lecture09/Lecture09_NichesAndHabitats.html)
- 10. [How to Model Anything - Part I](lectures/Lecture10/Lecture_Modeling.html)
- 11. [How to Model Anything - Part II](lectures/Lecture10/Lecture_Modeling_PartII.html)
- Special lecture: [Porcupine Caribou Resource Selection](lectures/Lecture10/Lecture_PCH_RSF.pdf)

### Unit IV. Population Ecology: *What is happening to how many there are?*
- 12. [Population Ecology - Part I - Exponential Growth](lectures/Module4_PopulationEcology/Lecture_PopulationEcology.html)
- 13. [Population Ecology - Part II - Carrying Capacity](lectures/Module4_PopulationEcology/Lecture_PopulationEcology_PartII.html)
- 14. [Population Ecology - Part III - All The Rest](lectures/Module4_PopulationEcology/Lecture_PopulationEcology_PartIII.html)
- 14b. [Matrix Models](lectures/Module4_PopulationEcology/StructuredPopulations_MiscellaneousSlides.pdf)<br>

- 15. [Physiology and Disease](lectures/Lecture13_Diseases/Lecture_WildlifeDiseases.html) (also: [COVID and Wildlife](lectures/Lecture13_Diseases/Covid and Wildlife.pdf) and [Wolf-Deer-CWD](lectures/Lecture13_Diseases/deer_wolf_CWD.pdf))

### Unit V. The North American Model of Wildlife Conservation

- 16. [Introduction to NAM](lectures/Lecture14_NorthAmericanModel/Lecture_NAM.html)
