---
title: ".white[More on Mark-Recapture and other Indices]"
...
system("cp ../mycss.css ./")
# system("cp images/scat.jpg ./bg.jpg")
xaringan::inf_mr()
```
...
<iframe src="https://www.youtube.com/embed/P9H-S7pMOf4?controls=0" width="900px" height="500px">
</iframe>
...
<iframe src="https://www.youtube.com/embed/n3YbcoTMQzk?controls=0" width="800px" height="450px"> </iframe>
...
$$SD(\widehat{N_1}) = \widehat{N_1} {q^* \over p^*} \sqrt{\frac{1}{I_1} + \frac{1}{I_2}}$$
...
$SE(Y1) ≈ 478\times(0.252/0.748)\times\sqrt{(1/301 + 1/76)} = 21$
]
...
.center[
```{r, out.width = "70%"}
knitr::include_graphics("images/shrike.jpg")
```
]
...
.pull-right-60[
Confersion to density estimate:
...
```{r, out.width = "90%"}
knitr::include_graphics("images/wildlifetriangle.jpeg")
```
...
```{r, out.width = "80%"}
knitr::include_graphics("images/finland.jpeg")
```
]
