...
subtitle: "[EFB 390: Wildlife Ecology and Management](https://eligurarie.github.io/EFB390/)"
...
<center>[Endangered Species Act, Section 3. Definitions](https://www.fws.gov/laws/endangered-species-act/section-3).
]
...
### .center[Well over 95% of bison in the US are managed as **livestock**]
...
.content-box-yellow[
.Large[categories and definitions end up being extremely important!]]
]
...
https://app.sli.do/event/7wqjVwSn3KP8s4zxxbH8Lu
...
is the study of interactions among free-living wild animals and their environment.  
...
- As an **applied** field, it is closely tied to **management** and **conservation**.
]
...
> ### IMHO ... 
>.large[
It is the **most interesting** and **most fun** field to work in ever.]
...
https://app.sli.do/event/7wqjVwSn3KP8s4zxxbH8Lu/embed/polls/8e6388db-77d2-43c6-880c-b26afdfc4ef6
...
- Implementation of actions that directly/indirectly impact the **population**.  
...
### By that definition there are only 4 Goals of Wildife Management
...
## Thinking more broadly about Wildlife Management ...
...
---
## Assignment (due next Tuesday, Sep. 2):


### 1. Wildlife in the news

a. Find **three popular press articles** about the interaction of wildlife and humans from the past year, involving **different species** and **different geographical areas** (at least one outside the United States).  These should be **news** (not editorial or opinion pieces). 

b. Enter into a survey **form**: 
...
- the **players**:  (e.g. wildlife ecologists, government agencies, non-government organization (NGO), the citizenry, random individuals).

c. You must print the articles to pdf, and .red[highlight] the portions of text you used to get 
...
**Readings:** Chapters 1 and 2 from Taber and Payne (uploaded on **BLACKBOARD**)
...
.pull-right-60[
On **Thursday**, we have a guest speaker from **Moon Library** to talk about research techniques.  We will be building and using a bibliography throughout the semester, so ... 

### Install **[Zotero](Zotero.org)** on your computers!
]
